                                ...
                                <div class="row">
                                    <div class=" col-3">
                                        ...
                                        <input type="text" class="form-control form-control" name="search"
                                            value="{{ request('search') }}" placeholder="Enter information">
                                    </div>
                                    <div class="col-3">
                                        <label class="form-label">Subject</label>
                                        <select name="subject" class="form-select" >
                                            <option value="">- Select subject -</option>
                                            <option value="order" {{ request('subject') == 'order' ? 'selected' : '' }}>Order</option>
                                            <option value="Product Information" {{ request('subject') == 'Product Information' ? 'selected' : '' }}>Product Information</option>
                                            <option value="Customer Service" {{ request('subject') == 'Customer Service' ? 'selected' : '' }}>Customer Service</option>
                                    ...
                                    <div class="col-md-2 d-flex ">
                                        ...
                                        <a href="{{ route('admin.contact.index1') }} "
                    ...
                    <tbody>
                        @foreach ($contacts as $contact)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning view-detail" data-bs-toggle="modal"
                                        data-bs-target="#contactModal" data-id="{{ $contact->id }}">
                                        Detail
                                    </a>
