...
<body>
                ...
                <div class="col-lg-8 mb-5 mb-lg-0">
                    ...
                    <form method="POST" action="{{ route('user.contact.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="contact-form">
                            ...
                            <br>
                            <p>
                                <textarea name="message" class="form-control" id="message" cols="30" rows="10" placeholder="Message"
                ...
                <div class="col-lg-4">
                    <div class="contact-form-wrap">
                        <div class="contact-form-box">
                            ...
                            <p>FPT Aptech, 590 Cach Mang Thang Tam <br> Ward 11, District 3, Ho Chi Minh. <br> Viet Nam
                            </p>
                        </div>
                        <div class="contact-form-box">
                        ...
                        <div class="contact-form-box">
                            ...
                            <p>Phone: +00 111 222 3333 <br> Email: fruitkha97@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="embed-responsive embed-responsive-21by9">
        <iframe
            ...
            width="600" height="450" style="border:0;" allowfullscreen="" frameborder="0" loading="lazy"
